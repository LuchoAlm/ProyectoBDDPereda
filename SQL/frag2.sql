...
CREATE DATABASE PeredaDentalSUC2
--USAR LA BASE DE DATOS
USE PeredaDentalSUC2 
--BORRAR LA BASE DE DATOS
DROP DATABASE PeredaDentalSUC2
----------------------------------------------------------------------------------------------------------------------------------
...
select [cedula_pac], [nombre_pac], [apellidos_pac] into PACIENTECITA_SUC2
from openquery ([CLINICADENTAL], 'select * from PACIENTE')
where 1 = 2

--Agregar como pk la pk copuesta por el id + campo de fragmentación
alter table PACIENTECITA_SUC2 add id_suc nvarchar(10) not null 
alter table PACIENTECITA_SUC2 add constraint pk_id_suc1 primary key (id_suc, cedula_pac)
sp_help PACIENTECITA_SUC2

--Ingresar datos
insert into PACIENTECITA_SUC2
select [cedula_pac],[nombre_pac],[apellidos_pac],[id_suc]  from openquery ([CLINICADENTAL],
'select * from PACIENTE where id_suc = "SUC2"');

--Ver datos
select * from PACIENTECITA_SUC2

--Borrar datos
drop table PACIENTECITA_SUC2
...
[contacto_telefonoFijo],[contactoCelular],[referidoPor], [id_suc] into PACIENTEDATOS_SUC2
from openquery ([CLINICADENTAL], 'select * from PACIENTE')
where 1 = 2

--Agregar como pk la pk copuesta por el id + campo de fragmentación
alter table PACIENTEDATOS_SUC2 add constraint pk_id_suc primary key (id_suc, cedula_pac)
sp_help PACIENTEDATOS_SUC2

--Ingresar datos
insert into PACIENTEDATOS_SUC2
select [cedula_pac],[edad_pac], [fechaNacimiento_pac],[direccion_pac], [canton_pac], [provincia_pac]
[teléfonoFijo_pac], [celular_pac],[correoElectronico_pac],[sexo_pac], [estado_pac], [contactoNombres], [contactoApellidos], 
...
--Ver datos
select * from PACIENTEDATOS_SUC2

--Borrar datos
drop table PACIENTEDATOS_SUC2

--TABLA: ODONTOLOGO

---------------- ODONTOLOGOCITA_SUC1 -------------------
--Replicación de los campos 
select [cedula_odon],[nombres_odon],[apellidos_odon] into ODONTOLOGOCITA_SUC2
from openquery ([CLINICADENTAL], 'select * from ODONTOLOGO')
where 1 = 2

--Agregar como pk la pk copuesta por el id + campo de fragmentación
alter table ODONTOLOGOCITA_SUC2 add id_suc nvarchar(10) not null 
alter table ODONTOLOGOCITA_SUC2 add constraint pk_id_suc2 primary key (id_suc, cedula_odon)
sp_help ODONTOLOGOCITA_SUC2

--Ingresar datos
insert into ODONTOLOGOCITA_SUC2
select [cedula_odon],[nombres_odon],[apellidos_odon],[id_suc] from openquery ([CLINICADENTAL],
'select * from ODONTOLOGO where id_suc = "SUC2"');


---------------- ODONTOLOGODATOS_SUC1 -------------------
--Replicación de los campos 
select [cedula_odon],[telefonoFijo_odon],[celular_odon],[especialidad_odon],[id_suc] into ODONTOLOGODATOS_SUC2
from openquery ([CLINICADENTAL], 'select * from ODONTOLOGO')
where 1 = 2

--Agregar como pk la pk copuesta por el id + campo de fragmentación
alter table ODONTOLOGODATOS_SUC2 add constraint pk_id_suc4 primary key (id_suc, cedula_odon)
sp_help ODONTOLOGODATOS_SUC2

--Ingresar datos
insert into ODONTOLOGODATOS_SUC2
select [cedula_odon],[telefonoFijo_odon],[celular_odon],[especialidad_odon],[id_suc] from openquery ([CLINICADENTAL],
'select * from ODONTOLOGO where id_suc = "SUC2"');


--Seleccionar tablas
select * from ODONTOLOGOCITA_SUC2
select * from ODONTOLOGODATOS_SUC2

--Borrar tablas
drop table ODONTOLOGOCITA_SUC2
drop table ODONTOLOGODATOS_SUC2
...
--Replicación de los campos 
select * into CITA_SUC2
from openquery ([CLINICADENTAL], 'select * from CITA')
where 1 = 2

--Agregar como pk la pk copuesta por el id + campo de fragmentación
alter table CITA_SUC2 add constraint pk_id_sucursal primary key (id_sucursal, id_cita)
sp_help DATOSCITA_SUC2

--Ingresar datos
insert into CITA_SUC2
select * from openquery ([CLINICADENTAL],
'select * from CITA where id_sucursal = "SUC2"');
...
from PACIENTECITA_SUC2 as p join CITA_SUC2 as c
on p.cedula_pac = c.cedula_paciente join ODONTOLOGOCITA_SUC2 as o 
on o.cedula_odon = c.cedula_odontologo join TRATAMIENTO as t
on t.id_trat = c.id_tratamiento
order by fecha_cita

--Borrar tablas
drop table CITA_SUC2

select * from ODONTOLOGOCITA_SUC2
select * from CITA_SUC2
select * from PACIENTECITA_SUC2
...
--Replicación de los campos 
select [id_hcl] into HISTORIACLINICACITA_SUC2
from openquery ([CLINICADENTAL], 'select * from HISTORIA_CLINICA')
where 1 = 2

--Agregar como pk la pk copuesta por el id + campo de fragmentación
alter table HISTORIACLINICACITA_SUC2 add id_suc nvarchar(10) not null 
alter table HISTORIACLINICACITA_SUC2 add constraint pk_id_suc5 primary key (id_suc, id_hcl)
sp_help HISTORIACLINICACITA_SUC2

--Ingresar datos
insert into HISTORIACLINICACITA_SUC2
select * from openquery ([CLINICADENTAL],
'select hcl.id_hcl,c.id_sucursal  
from HISTORIA_CLINICA as hcl 
join CITA as c
ON hcl.id_hcl = c.id_hclinica WHERE c.id_sucursal = "SUC2"')


--Seleccionar tablas
select * from HISTORIACLINICACITA_SUC2

--Borrar tablas
drop table HISTORIACLINICACITA_SUC2


---------------- HISTORIACLINICA_DATOS_SUC1 -------------------
select * into HISTORIACLINICA_DATOS_SUC2
from openquery ([CLINICADENTAL], 'select * from HISTORIA_CLINICA')
where 1 = 2

--Agrega el campo de fragmentación y la pk de la tabla que depende como atributos
--1
alter table HISTORIACLINICA_DATOS_SUC2 add id_cita nvarchar(10) not null
alter table HISTORIACLINICA_DATOS_SUC2 add id_suc nvarchar(10) not null
--2
alter table HISTORIACLINICA_DATOS_SUC2 add constraint fk_id_cita2 foreign key (id_suc, id_cita)
references CITA_SUC1 (id_sucursal, id_cita)
--3
alter table HISTORIACLINICA_DATOS_SUC2 add constraint pk_id_hcl2 primary key (id_hcl, id_suc)


--Ingresar datos
insert into HISTORIACLINICA_DATOS_SUC2 
select * from openquery ([CLINICADENTAL],
...
where C.id_sucursal = "SUC2" and C.id_hclinica = HCL.id_hcl')


--Seleccionar tablas
select * from HISTORIACLINICA_DATOS_SUC2

--Borrar tablas
drop table HISTORIACLINICA_DATOS_SUC2
...
sp_addlinkedserver 'WIN-BBGCNF1VMO9', 'SQL Server'
sp_addlinkedsrvlogin 'WIN-BBGCNF1VMO9', 'true'
sp_droplinkedsrvlogin 'WIN-BBGCNF1VMO9'
...
alter table [PACIENTECITA_SUC2] add constraint Ck_id_suc check (id_suc='SUC2')
...
insert into Paciente_Cita values ('1757203912','Rebeca','Zambrano Pereda','SUC1')
commit
...
--Agregar el check con el campo de fragmentación igual a SUC1
alter table [PACIENTEDATOS_SUC2] add constraint Ck_id_suc2 check (id_suc='SUC2')
...
--Agregar el check con el campo de fragmentación igual a SUC1
alter table [ODONTOLOGOCITA_SUC2] add constraint Ck_id_suc3 check (id_suc='SUC2')
...
--Agregar el check con el campo de fragmentación igual a SUC1
alter table [ODONTOLOGODATOS_SUC2] add constraint Ck_id_suc4 check (id_suc='SUC2')
...
--Agregar el check con el campo de fragmentación igual a SUC1
alter table [HISTORIACLINICACITA_SUC2] add constraint Ck_id_suc5 check (id_suc='SUC2')
...
--Agregar el check con el campo de fragmentación igual a SUC1
alter table [HISTORIACLINICA_DATOS_SUC2] add constraint Ck_id_suc6 check (id_suc='SUC2')
