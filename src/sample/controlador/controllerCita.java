...
public class controllerCita implements Initializable {
    ...
    @FXML
    private AnchorPane paneOpciones, paneRegistrarAgenda, paneConsultarCita, paneActualizarCita, paneEliminarCita;
    @FXML
    private JFXButton btnRegistrarCita,btnConsultarCita, btnActualizarCita, btnEliminarCita;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        regresarOpciones.setOnMouseClicked(mouseEvent -> {
            paneActualizarCita.setVisible(false);
        ...
        btnActualizarCita.setOnMouseClicked(mouseEvent -> {
            paneOpciones.setVisible(false);
            paneActualizarCita.setVisible(true);
            regresar.setVisible(false);
            regresarOpciones.setVisible(true);
        });
